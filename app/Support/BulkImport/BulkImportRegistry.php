        ...
        return [
            'funcionarios' => [
                ...
                'columns' => [
                    ...
                    ['key' => 'estatus', 'label' => 'estatus', 'required' => true, 'example' => 'Operativo', 'help' => 'Operativo, No Operativo, En Reposo, Reingreso, Retirado, Suspendido, Jubilado, Fallecido, URRA'],
                    ['key' => 'tipo_retiro', 'label' => 'tipo_retiro', 'required' => false, 'example' => 'Renuncia', 'help' => 'Obligatorio si estatus=Retirado → Renuncia | Destitución'],
                    ['key' => 'fechas_reingreso', 'label' => 'fechas_reingreso', 'required' => false, 'example' => '10/01/2018;15/03/2022', 'help' => 'Si estatus=Reingreso: una o más fechas separadas por ;'],
                    ['key' => 'tipo_funcionario', 'label' => 'tipo_funcionario', 'required' => true, 'example' => 'Policial', 'help' => 'Policial | Administrativo | Obrero'],
                    ['key' => 'estacion_servicio', 'label' => 'estacion_servicio', 'required' => false, 'example' => 'Comando Valera', 'help' => 'Estación donde presta servicio (se busca/crea en catálogo)', 'aliases' => ['estacion', 'estación', 'estacion de servicio', 'estación de servicio', 'estacion servicio', 'unidad']],
                ...
                'notes' => [
                    ...
                    'Si estatus=Retirado, indique tipo_retiro (Renuncia o Destitución).',
                    'Si estatus=Reingreso, indique fechas_reingreso separadas por ;',
            ...
            'nombramientos' => [
                ...
                'columns' => [
                    ...
                    ['key' => 'fecha_inicio', 'label' => 'fecha_inicio', 'required' => true, 'example' => '01/03/2024', 'help' => 'YYYY-MM-DD o DD/MM/YYYY', 'aliases' => ['fecha inicio', 'desde']],
                    ['key' => 'fecha_final', 'label' => 'fecha_final', 'required' => false, 'example' => '30/06/2024', 'help' => 'YYYY-MM-DD o DD/MM/YYYY', 'aliases' => ['fecha fin', 'fecha final', 'hasta']],
                    ['key' => 'is_actual', 'label' => 'is_actual', 'required' => false, 'example' => '1', 'help' => '0 o 1 — nombramiento actual', 'aliases' => ['actual', 'vigente']],
                    ['key' => 'descripcion', 'label' => 'descripcion', 'required' => false, 'example' => 'Nombramiento provisional', 'help' => 'Descripción / observaciones', 'aliases' => ['observaciones', 'nota', 'detalle']],
                ],
                'notes' => [
                    'El funcionario (documento_identidad) debe existir previamente.',
