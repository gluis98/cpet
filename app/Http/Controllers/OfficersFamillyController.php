...
class OfficersFamillyController extends Controller
{
    ...
    public function index($id) {
        return response()->json(OficialesFamiliare::where('id_policia', $id)->get(), 200);
    }
    ...
    public function store(Request $request) {
        $oficiales = OficialesFamiliare::create($request->all());
    ...
    public function show($id) {
        return response()->json(OficialesFamiliare::findOrFail($id), 200);
    }
     ...
     */
     public function update(Request $request, $id) {
        $oficiales = OficialesFamiliare::findOrFail($id);
