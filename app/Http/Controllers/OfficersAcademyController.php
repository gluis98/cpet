...
class OfficersAcademyController extends Controller
{
    ...
    public function index($id) {
        return response()->json(OficialesAcademico::where('id_policia', $id)->get(), 200);
    }
    ...
    public function store(Request $request) {
        $oficiales = OficialesAcademico::create($request->all());
    ...
    public function show($id) {
        return response()->json(OficialesAcademico::findOrFail($id), 200);
    }
     ...
     */
     public function update(Request $request, $id) {
        $oficiales = OficialesAcademico::findOrFail($id);
